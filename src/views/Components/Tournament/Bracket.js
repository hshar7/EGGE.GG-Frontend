      ...
      this.props.matches.forEach(match => {
        ...
        if (match.winner) {
          if (match.winner.name === match.player1) {
            elements.push(
              <li className="game game-top winner"> {match.player1} </li>
            );
            ...
            elements.push(<li className="game game-spacer"> &nbsp;</li>);
            elements.push(
              <li className="game game-top winner"> {match.player2} </li>
            );
          }
        } else {
          elements.push(
            <li
              onClick={() => this.props.winner1(match.matchId)}
          ...
          elements.push(
            <li
              onClick={() => this.props.winner2(match.matchId)}
